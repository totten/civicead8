 ...
 *
 */
class org_ceacisp_sourcecontrib extends CRM_Report_Form {
      ...
      'civicrm_financial_trxn' => array(
        ...
        array(
          ...
          'payment_processor_id' => array(
            'title' => ts('Payment Processor'),
            'operatorType' => CRM_Report_Form::OP_MULTISELECT,
            'options' => CRM_Contribute_PseudoConstant::paymentProcessor(),
          ),
          'currency' => array(
             'title' => 'Currency',
             'operatorType' => CRM_Report_Form::OP_MULTISELECT,
        ...
        'order_bys' => array(
          'payment_processor_id' => array('title' => ts('Payment Processor')),
        ),
      ),
...
";
  ...
  function alterDisplay(&$rows) {
    ...
    $paymentProcessors = CRM_Contribute_PseudoConstant::paymentProcessor();
    ...
    foreach ($rows as $rowNum => $row) {
      ...
      if ($value = CRM_Utils_Array::value('civicrm_financial_trxn_payment_processor_id', $row)) {
        $rows[$rowNum]['civicrm_financial_trxn_payment_processor_id'] = $paymentProcessors[$value];
      }
